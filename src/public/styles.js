...
body{opacity:0;background-color:#efeae2}
...
.action_button{display:block;text-align:center;border:1px solid #AAAAAA;height:40px;background-color:#C8C8C8;border-radius:5px;padding-left:12px;padding-right:12px;cursor:pointer;outline:0px solid #C8C8C8}
...
.agent_image{float:left;background-color:white;margin-left:15px;border-radius:20px;width:40px;height:40px;background-image:url(agent.png);background-size:40px 40px;background-repeat:no-repeat;border:1px solid rgba(206,206,206,0.4);}
.agent_name{float:left;margin-left:20px;color:black}
...
body{opacity:0;background-color:#0b141a}
...
.agent_container{position:fixed;left:0;right:0;top:0;height:64px;display:flex;align-items:center}
.agent_image{float:left;background-color:white;margin-left:15px;border-radius:20px;width:40px;height:40px;background-image:url(agent.png);background-size:40px 40px;background-repeat:no-repeat;border:1px solid rgba(0,0,0,0.8)}
.agent_name{float:left;margin-left:20px;color:white;font-weight:bold}
.prompt{margin-bottom:10px;margin-left:10px;text-align:right;word-break:break-word}
